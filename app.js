...
main().then(() => {
    console.log("✅ Connected to MongoDB — Campus Connect is live!");
}).catch((err) => {
    console.log(err);
});
...
app.get("/", async (req, res) => {
    ...
    res.render("home.ejs", { totalProblems, solvedProblems, totalUsers, totalSolutions });
});

app.use("/problems", problemsRouter);
app.use("/problems/:id/solutions", solutionsRouter);
app.use("/", userRouter);
